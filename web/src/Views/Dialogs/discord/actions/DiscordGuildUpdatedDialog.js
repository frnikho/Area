...
export default class DiscordGuildUpdatedDialog extends ActionSettingsDialog {
    ...
    onCreate() {
        ...
        const action = {
            action_type: "discord_guild_update",
            base_key: guildId,
            action: {
                parameters: [
                    {
...
DiscordGuildUpdatedDialog.propTypes = ActionSettingsDialog.propTypes;
