...
export default class DiscordGuildMessageDeletedDialog extends ActionSettingsDialog {
    ...
    onCreate() {
        ...
        const action = {
            action_type: "discord_guild_message_deleted",
            base_key: guildId,
            action: {
                parameters: [
                    {
...
DiscordGuildMessageDeletedDialog.propTypes = ActionSettingsDialog.propTypes;
